...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print(
            "Usage: python gen_dependency_graph.py DEP_FILES_DIR OUTPUT_PATH [IGNORE_DIR]"
            "python gen_dependency_graph.py ../../../build ./right_here"
            "or"
            "python gen_dependency_graph.py ../../../build ./right_here ../../../build/thirdparty"
        )
    else:
